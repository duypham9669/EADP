...
namespace Client.ServiceReference1 {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="Account", Namespace="http://schemas.datacontract.org/2004/07/WcfService1.Models")]
    [System.SerializableAttribute()]
    public partial class Account : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private string SercurityCodeField;
        ...
        public string SercurityCode {
            get {
                return this.SercurityCodeField;
            }
            set {
                if ((object.ReferenceEquals(this.SercurityCodeField, value) != true)) {
                    this.SercurityCodeField = value;
                    this.RaisePropertyChanged("SercurityCode");
                }
            }
        }
    ...
    public interface IService1 {
        ...
        Client.ServiceReference1.Account GetAccount(string code, string pass);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/GetAccount", ReplyAction="http://tempuri.org/IService1/GetAccountResponse")]
        System.Threading.Tasks.Task<Client.ServiceReference1.Account> GetAccountAsync(string code, string pass);
        ...
        bool TransferMoney(string sCode, string rCode, double amount);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IService1/TransferMoney", ReplyAction="http://tempuri.org/IService1/TransferMoneyResponse")]
        System.Threading.Tasks.Task<bool> TransferMoneyAsync(string sCode, string rCode, double amount);
    }
    ...
    public partial class Service1Client : System.ServiceModel.ClientBase<Client.ServiceReference1.IService1>, Client.ServiceReference1.IService1 {
        ...
        public Client.ServiceReference1.Account GetAccount(string code, string pass) {
            return base.Channel.GetAccount(code, pass);
        }
        
        public System.Threading.Tasks.Task<Client.ServiceReference1.Account> GetAccountAsync(string code, string pass) {
            return base.Channel.GetAccountAsync(code, pass);
        }
        
        public bool TransferMoney(string sCode, string rCode, double amount) {
            return base.Channel.TransferMoney(sCode, rCode, amount);
        }
        
        public System.Threading.Tasks.Task<bool> TransferMoneyAsync(string sCode, string rCode, double amount) {
